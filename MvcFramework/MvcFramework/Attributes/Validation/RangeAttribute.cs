...
namespace MvcFramework.Attributes.Validation
{
	public class RangeAttribute : ValidationAttribute
	{
		...
		public RangeAttribute(int minValue, int maxValue, string errorMessage = DefaultErrorMessage) : base(errorMessage)
		{
		...
		public RangeAttribute(double minValue, double maxValue, string errorMessage = DefaultErrorMessage) : base(errorMessage)
		{
			this.minValue = minValue;
			this.maxValue = maxValue;
		...
		public RangeAttribute(Type type, string minValue, string maxValue, string errorMessage = DefaultErrorMessage) : base(errorMessage)
		{
			this.minValue = minValue;
			this.maxValue = maxValue;
